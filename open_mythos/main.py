...
class MythosConfig:
    ...
    lora_rank: int = 16
    # Performance: use torch.nn.functional.scaled_dot_product_attention
    use_sdpa: bool = True
...
class GQAttention(nn.Module):
    ...
    def forward(
        ...
        if self.use_sdpa:
            # torch.nn.functional.scaled_dot_product_attention handles
            # scaling, masking, and softmax internally.
